        ...
        <div class="header">
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <span class="user-img"><img class="rounded-circle" src="assets/images/avatar-01.jpg" width="31" alt="Ryan Taylor"></span>
                    </a>
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="assets/images/avatar-01.jpg" alt="User Image"
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-chalkboard-teacher"></i> <span> Teachers</span> <span lass="menu-arrow"></span></a>
                        ...
                        <li class="submenu">
                            <!-- <a href="#"><i class="fas fa-file-invoice-dollar"></i> <span> Accounts</span>  -->
                            <!-- <ul>
